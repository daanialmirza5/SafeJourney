...
INSERT INTO "new_FollowUpTask" ("assignedToId", "completedAt", "createdAt", "createdById", "description", "dueDate", "id", "referralId", "source", "status", "title", "updatedAt") SELECT "assignedToId", "completedAt", "createdAt", "createdById", "description", "dueDate", "id", "referralId", "source", "status", "title", "updatedAt" FROM "FollowUpTask";
